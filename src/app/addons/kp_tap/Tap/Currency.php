...
class Currency {
    ...
    public static function getTapCurrencyMultiplier( $currency_iso_code ) {
        $currency = self::getTapCurrency( $currency_iso_code );
    ...
    public static function getTapCurrency( $currency_iso_code ) {
    ...
    public static function toTapCurrency($total, $multiplier) {
